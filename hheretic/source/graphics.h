...
void rescaler(u32 *scr, int wscr, int hscr, u32 *buf, int wbuf, int hbuf); // to the screen
void virtual_rescaler(int wscr, int hscr, u32 *buf, int wbuf, int hbuf); // to the virtual screen
